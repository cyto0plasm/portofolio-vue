    ...
    <div class="flex flex-col justify-start p-6 flex-1 gap-3">
      ...
      <div class="flex flex-col gap-2.5 flex-1">
        ...
        >
          ...
          <span class="text-zinc-700 text-xs select-none" aria-hidden="true"
            >·</span
          >

          <h2
            class="text-sm font-medium text-zinc-400 hover:text-green-400 transition-colors duration-300 underline decoration-zinc-600/40 underline-offset-2 w-fit"
          >
    ...
    >
      ...
      >
        ...
        <div
          ...
          class="flex items-center gap-1 px-3 pt-2.5"
        >
          <div
            v-for="(_, i) in imageSrcs.slice(0, 3)"
            :key="i"
        ...
        <!-- Images -->
        <div
          class="relative flex items-center justify-center flex-1 min-h-0 p-2"
        >
          <MultiImage
        ...
        <div
          :dir="isAr ? 'ltr' : 'rtl'"
          class="flex gap-1 justify-center py-2.5 px-3 mt-1 mx-2 mb-2 rounded-xl bg-zinc-200/60 dark:bg-zinc-800/60 border border-zinc-200/50 dark:border-zinc-700/40"
        >
          <!-- Views -->
          <button
            type="button"
